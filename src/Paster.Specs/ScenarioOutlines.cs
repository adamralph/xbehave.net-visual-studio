...
namespace Paster.Specs
{
    ...
    public class ScenarioOutlines
    {
        ...
        public void TwoExamples(EnvironmentClipboard clipboard, GherkinPaster sut, TestEnvironment environment, StringBuilder stringBuilder)
        {
            ...
            "Then the fourth line emitted is the method name with parameters".Then(() => environment.LinesWritten[3].Should()
                                                                                                                    .Be(
                                                                                                                        "public void Eating(string start, int eat, double left)"));

            "Then the instructions emitted have had their placeholders replaced".Then(() =>
                                                                                          {
            ...
            "Then the environment receives a test method with examples".Then(() =>
                                                                                 {
                                                                                     ...
                                                                                     sb.AppendLine("{");
                                                                                     sb.AppendLine(
                                                                                                   "\"Given there are {0} cucumbers\".Given(() => {});");
                                                                                     sb.AppendLine(
                                                                                                   "\"When I eat {1} cucumbers\".When(() => {});");
                                                                                     sb.AppendLine(
                                                                                                   "\"Then I should have {2} cucumbers\".Then(() => {});");
                                                                                     sb.AppendLine("}");
