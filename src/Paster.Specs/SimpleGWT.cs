    ...
    public class SimpleGWT
    {
                                   ...
                                   TestEnvironment environment)
        {
            ...
            "The the first line pasted should have the code '.Given(() => {});'".Then(() => environment.LinesWritten[0].Should()
                                                                                                                       .Contain(".Given(() => {});"));
            "The the second line pasted should have the code '.And(() => {});'".Then(() => environment.LinesWritten[1].Should()
                                                                                                                     .Contain(".And(() => {});"));
            "The the third line pasted should have the code '.When(() => {});'".Then(() => environment.LinesWritten[2].Should()
                                                                                                                       .Contain(".When(() => {});"));
            "The the forth line pasted should have the code '.Then(() => {});'".Then(() => environment.LinesWritten[3].Should()
                                                                                                                      .Contain(".Then(() => {});"));
        }
    }
}